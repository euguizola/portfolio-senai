...
window.addEventListener('load', ()=>{
  ...
  document.querySelector('.app').addEventListener('mousedown', (e) => {
      ...
      t5 = TweenMax.to(".identity h1", 0.8, {transform:"translateX(0)", delay: 0.1})
      t6 = TweenMax.to(".identity h2", 0.8, {transform:"translateY(0)", delay: 0.1})
  ...
  document.querySelector('.app').addEventListener('mouseup', (e) => {
      ...
      t1.reverse()
      t2 = TweenMax.to(".thumb-mask", 0.3, {width: "100%", filter: "grayscale(0%) brightness(1)"})
      t3.reverse()
      t4.reverse()
      t5.reverse()
      t6.reverse()

...
class Ecub extends Component {
  ...
  componentWillMount() {
    fetch('https://cors-anywhere.herokuapp.com/https://www.behance.net/v2/projects/67606483?api_key=OgcEKxgXnxNcHihcPqcTeK0dY7pAYwik')
    .then(response => {

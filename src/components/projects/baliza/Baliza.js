...
class Baliza extends Component {
  constructor() {
    super();
    this.state = {
      owners: []
  ...
  componentWillMount() {
    fetch('https://cors-anywhere.herokuapp.com/https://www.behance.net/v2/projects/68322281?api_key=OgcEKxgXnxNcHihcPqcTeK0dY7pAYwik')
    .then(response => {
